...
public class RoleDaoImpl implements RoleDao {
    ...
    public Role createRole(final Role role) {
        final String sql = "insert into help_role(role, description, resource_ids, available) values(?,?,?,?)";
    ...
    public Role updateRole(Role role) {
        final String sql = "update help_role set role=?, description=?, resource_ids=?, available=? where id=?";
        jdbcTemplate.update(
                sql,
    ...
    public void deleteRole(Integer roleId) {
        final String sql = "delete from help_role where id=?";
        jdbcTemplate.update(sql, roleId);
    }


    public Role findOne(Integer roleId) {
        final String sql = "select id, role, description, resource_ids as resourceIdsStr, available from help_role where id=?";
    ...
    public List<Role> findAll() {
        final String sql = "select id, role, description, resource_ids as resourceIdsStr, available from help_role";
